...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', action='store_true', help='anon')
    parser.add_argument('-f', action='store_true', help='anon')
    parser.add_argument('-l', action='store_true', help='anon')
    ...
    if args.l:
        GETH_DATADIR = '/Users/anon/geth_testnet'
